/**
 * ### ModalDialog Web Componant - v1.7
...
class AlertModalDialog extends ModalDialogElement {
  ...
  setAlert(content, title) {
    ...
    const dialogFooterElm = self.shadowRoot.querySelector(
      ".modal-dialog-footer",
    );
    ...
    return new Promise(function (resolve) {
      dialogConfirmBtn.addEventListener(
        "click",
        function dialogConfirmBtnClick() {
  ...
  setConfirm(condition, title) {
    ...
    return new Promise(function (resolve) {
      dialogBtnCancel.addEventListener(
        "click",
        function dialogBtnCancelClick() {
          this.removeEventListener("click", dialogBtnCancelClick);
          self.disposeDialog();
          resolve(false);
        },
      );
      dialogBtnConfirm.addEventListener(
        "click",
        function dialogBtnConfirmClick() {
